...
namespace Microsoft.Samples.Kinect.BodyBasics.Gestures
{
    ...
    public class PokeSegment1 : IGestureSegment
    {
        /// <summary>
        ...
        public GesturePartResult Update(Body skeleton)
        {
            ...
            {
                PokeGestureData.startDistance = Math.Sqrt(Math.Pow(skeleton.Joints[MouseMoveData.signalHand].Position.X - skeleton.Joints[signalShoulder].Position.X, 2) +
    ...
    public class PokeSegment2 : IGestureSegment
    {
        /// <summary>
        /// Updates the current gesture.
        /// </summary>
